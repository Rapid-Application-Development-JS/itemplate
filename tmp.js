...
//  issue 
elementOpen('ul', null, null);
data.listItems.forEach(function(listItem, i) {         if (listItem.hasOlympicGold){
elementOpen('li', null, null, 'class', 'row');
} else {
elementOpen('li', null, null, 'class', 'row even');
}
...
// keys cases
elementVoid('div', 'UavnOaBQtMUB', null);
elementVoid('div', 'my-custom-key', null);


// arrays cases
elementVoid('div', null, jLsLnsoTHVXY);
elementVoid('div', null, myCustomArray);

{ jLsLnsoTHVXY: [ 'class', 'box', 'style', 'align-content: center;' ],
